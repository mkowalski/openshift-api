...
var map_BareMetalPlatformSpec = map[string]string{
	...
	"machineNetworks":      "IP networks used to connect all the OpenShift cluster nodes. Each network is provided in the CIDR format, e.g. \"192.0.2.0/24\"",
}
...
var map_BareMetalPlatformStatus = map[string]string{
	...
	"machineNetworks":      "IP networks used to connect all the OpenShift cluster nodes.",
}
